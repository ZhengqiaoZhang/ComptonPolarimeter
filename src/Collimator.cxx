...
//_____________________________________________________________________________
Collimator::Collimator(const G4String& nam, G4double x, G4double y, G4double z, G4double R_inner, G4double R_outer, G4double zsize,G4double rotation,const G4String& Win_mat,G4double color1,G4double color2,G4double color3,G4LogicalVolume *top): Detector(),
  ...
  //G4double xysize = 2000*mm;
          G4Tubs *shape = new G4Tubs("fNam",R_inner,R_outer,zsize*0.5, 0, 360*deg);
...
G4RotationMatrix* rot_y = new G4RotationMatrix;
  ...
  fSelectPrim = true;
  //G4cout << "  Collimator, select_prim: " << fSelectPrim << G4endl;
...
//_____________________________________________________________________________
G4bool Collimator::ProcessHits(G4Step *step, G4TouchableHistory*) {
...
//  G4cout<<" Hits X: "<<fHx<<" Hits Y: "<<fHy<<" Hits Z: "<<fHz<<G4endl;
  //G4cout << "Collimator::ProcessHits: " << track->GetParentID() << G4endl;
...
//_____________________________________________________________________________
void Collimator::CreateOutput(TTree *tree) {

  //output from Collimator
