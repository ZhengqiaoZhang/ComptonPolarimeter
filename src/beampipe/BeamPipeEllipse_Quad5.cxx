...
//_____________________________________________________________________________
BeamPipeEllipse_Quad5::BeamPipeEllipse_Quad5(G4String nam, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double Dx,G4double Dy, G4double pipeThick, G4double angle,G4double gradient,G4LogicalVolume *top):Detector(), G4VSensitiveDetector(nam), fNam(nam) {
	...
	G4ThreeVector subtractBoxPosition(-0.046658010*meter, 0, 1.0108003*meter);
...
}//BeamPipeEllipse_Quad5

//_____________________________________________________________________________
G4bool BeamPipeEllipse_Quad5::ProcessHits(G4Step *step, G4TouchableHistory*) {
	...
	//G4cout << "BeamPipeEllipse_Quad5::ProcessHits: " << track->GetParentID() << G4endl;
...
//_____________________________________________________________________________
void BeamPipeEllipse_Quad5::CreateOutput(TTree *tree) {

	//output from BeamPipeEllipse_Quad5
...
//_____________________________________________________________________________
void BeamPipeEllipse_Quad5::ClearEvent() {
	ntrack = 0;
	for(int i=0;i<10;i++){
		fIsHit[i] = kFALSE;
