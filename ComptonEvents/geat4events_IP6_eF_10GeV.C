...
const double fEmmY = 1.3e-9;
const double AlphaX = -2.2495;
const double AlphaY = 5.323;
const double BetaX = 3.094;
const double BetaY = 65.740;


void geat4events_IP6_eF_10GeV(){
	double com1 = 0;
	double com3 = 0;
	...
	outf.open("10GeV_S3_Ver8.0_L.dat");

	ofstream outf1;
        //outf1.open("IP6_18GeV_S1_Ver8.0_L.dat");
        outf1.open("10GeV_S1_Ver8.0_L.dat");
	...
	TFile *store = new TFile("10GeV_QA.root","recreate");
	...
	file1.open("../events_10GeV_large.dat");
