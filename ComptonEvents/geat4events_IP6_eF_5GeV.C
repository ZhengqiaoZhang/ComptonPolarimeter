...
const double fEmmX = 2.0e-8;
const double fEmmY = 3.5e-9;
const double AlphaX = -1.4067755;
const double AlphaY = 6.1544438;
const double BetaX = 11.936708;
const double BetaY = 39.746996;

void geat4events_IP6_eF_5GeV(){
	double com1 = 0;
	double com3 = 0;
	...
	outf.open("5GeV_S3_Ver8.0_L.dat");

	ofstream outf1;
        //outf1.open("IP6_18GeV_S1_Ver8.0_L.dat");
        outf1.open("5GeV_S1_Ver8.0_L.dat");
...
*/
	...
	TFile *store = new TFile("5GeV_QA.root","recreate");
	...
	file1.open("../events_5GeV_large.dat");
