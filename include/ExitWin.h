...
class ExitWin : public Detector, public G4VSensitiveDetector {

  public:

    ExitWin(const G4String&, G4double x, G4double y, G4double z, G4double xysize,G4double zsize,G4double rot,const G4String&,G4double c1,G4double c2,G4double c3,G4LogicalVolume *top);
    virtual ~ExitWin() {}
