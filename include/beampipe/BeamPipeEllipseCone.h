...
#ifndef BeamPipeEllipseCone_h
#define BeamPipeEllipseCone_h
...
class BeamPipeEllipseCone : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeEllipseCone(G4String nam, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double Dx,G4double Dy,G4double Dx_top,G4double Dy_top, G4double pipeThick, G4double angle,G4LogicalVolume *top);
		virtual ~BeamPipeEllipseCone() {}
