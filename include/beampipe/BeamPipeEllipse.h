...
#ifndef BeamPipeEllipse_h
#define BeamPipeEllipse_h
...
class BeamPipeEllipse : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeEllipse(G4String nam, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double Dx,G4double Dy, G4double pipeThick, G4double angle,G4LogicalVolume *top);
		virtual ~BeamPipeEllipse() {}
