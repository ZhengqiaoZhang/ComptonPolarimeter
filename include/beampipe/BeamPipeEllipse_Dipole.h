...
#ifndef BeamPipeEllipse_Dipole_h
#define BeamPipeEllipse_Dipole_h
...
class BeamPipeEllipse_Dipole : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeEllipse_Dipole(G4String nam, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double Dx,G4double Dy, G4double pipeThick, G4double angle,G4double gradient,G4LogicalVolume *top);
		virtual ~BeamPipeEllipse_Dipole() {}
