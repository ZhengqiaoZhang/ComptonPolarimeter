...
#ifndef BeamPipeTubs_Quad_h
#define BeamPipeTubs_Quad_h
...
class BeamPipeTubs_Quad : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeTubs_Quad(G4String nam, G4double xpos,G4double ypos,G4double zpos,G4double length,G4double gradient, G4double pipeSize, G4double pipeThick, G4double angle,G4LogicalVolume *top);
		virtual ~BeamPipeTubs_Quad() {}
