...
#ifndef BeamPipeHalfEllipse_h
#define BeamPipeHalfEllipse_h
...
class BeamPipeHalfEllipse : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeHalfEllipse(G4String nam,G4String lr, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double Dx,G4double Dy, G4double pipeThick, G4double angle,G4LogicalVolume *top);
		virtual ~BeamPipeHalfEllipse() {}
