...
#ifndef BeamPipeEllipseAsym_WinDesign_h
#define BeamPipeEllipseAsym_WinDesign_h
...
class BeamPipeEllipseAsym_WinDesign : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeEllipseAsym_WinDesign(G4String nam, G4String nam1,G4double xpos,G4double ypos,G4double zpos,G4double length, G4double Dx,G4double Dy,G4double Dx1,G4double Dy1, G4double pipeThick, G4double angle,G4LogicalVolume *top);
		virtual ~BeamPipeEllipseAsym_WinDesign() {}
