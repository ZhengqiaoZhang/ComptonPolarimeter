...
#ifndef BeamPipeEllipse_Quad5_h
#define BeamPipeEllipse_Quad5_h
...
class BeamPipeEllipse_Quad5 : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeEllipse_Quad5(G4String nam, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double Dx,G4double Dy, G4double pipeThick, G4double angle,G4double gradient,G4LogicalVolume *top);
		virtual ~BeamPipeEllipse_Quad5() {}
