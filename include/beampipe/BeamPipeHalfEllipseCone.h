...
#ifndef BeamPipeHalfEllipseCone_h
#define BeamPipeHalfEllipseCone_h
...
class BeamPipeHalfEllipseCone : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeHalfEllipseCone(G4String nam,G4String lr, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double Dx,G4double Dy,G4double Dx_top,G4double Dy_top, G4double pipeThick, G4double angle,G4LogicalVolume *top);
		virtual ~BeamPipeHalfEllipseCone() {}
