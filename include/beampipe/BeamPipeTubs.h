...
#ifndef BeamPipeTubs_h
#define BeamPipeTubs_h
...
class BeamPipeTubs : public Detector, public G4VSensitiveDetector {

	public:
		BeamPipeTubs(G4String nam, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double pipeSize, G4double pipeThick, G4double angle,G4LogicalVolume *top);
		virtual ~BeamPipeTubs() {}
