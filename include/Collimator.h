...
class Collimator : public Detector, public G4VSensitiveDetector {

  public:

    Collimator(const G4String&, G4double x, G4double y, G4double z, G4double R_inner,G4double R_outer,G4double zsize,G4double rot,const G4String&,G4double c1,G4double c2,G4double c3,G4LogicalVolume *top);
    virtual ~Collimator() {}
