...
#ifndef photonDet_Si_h
#define photonDet_Si_h
...
class photonDet_Si : public Detector, public G4VSensitiveDetector {

  public:

    photonDet_Si(G4String nam, G4double xpos,G4double ypos,G4double zpos, G4double angle,G4double xysiz_lead,G4double zsiz_lead,G4double deltaD, G4LogicalVolume *top);
    virtual ~photonDet_Si() {}
