...
//
//   G4EllipticalTube_new( const G4String& name,
//                           G4double  Dx,
//                           G4double  Dy,
//                           G4double  Dz )
//
...
#define G4GEOM_USE_UELLIPTICALTUBE 1
  ...
  #define G4UEllipticalTube G4EllipticalTube_new
...
class G4EllipticalTube_new : public G4VSolid
{
  public:  // with description
    ...
    inline void SetDf( G4double ScaleF);
 
  public:  // without description

    G4EllipticalTube_new(__void__&);
      // Fake default constructor for usage restricted to direct object
      // persistency for clients requiring preallocation of memory for
      // persistifiable objects

    G4EllipticalTube_new(const G4EllipticalTube_new& rhs);
    G4EllipticalTube_new& operator=(const G4EllipticalTube_new& rhs);
