...
void calXY_circle() {
    //double x1 = 0.3440665993, y1 = 93.27935437; // 起始点
    	double x1 = -589.52285069675,y1=31.181680078296;
    double theta1 = -3.1350926535898;//M_PI / 4; // 初始方向（以弧度为单位）
    ...
    // 输出旋转后的坐标
    std::cout << "The new point is at (" << newPoint.x << ", " << newPoint.y << ")" << std::endl;
